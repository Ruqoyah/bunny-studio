...
const UpdateUser = ({ editToggleModal }) => (
            ...
            <div className="modal-content text-left">
                ...
                <div className="px-8 pb-6">
                    <form className="text-center">
                        ...
                        <button className="bg-primaryBlue w-full py-2 text-center text-white mt-3 md:text-lg hover:bg-blue-600">Update User</button>
                    </form>
                </div>
            </div>
        </div>
